    ...
    <div className="min-h-screen bg-dark-900 flex items-center justify-center p-6 cyber-grid">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-dark-300 font-medium tracking-wide text-center">Sign in to discover and recruit athletes.</p>
        </div>
        ...
        <p className="text-center mt-8 text-sm text-dark-400">
          Need an account?{' '}
          <Link to="/coach/signup" className="text-brand-500 font-black uppercase tracking-widest hover:text-brand-400 transition-colors">
            Sign Up
          </Link>
        </p>
        ...
        <p className="text-center mt-4 text-sm text-dark-400">
          Not a coach?{' '}
          <Link to="/auth" className="text-brand-500 font-black uppercase tracking-widest hover:text-brand-400 transition-colors">
            Athlete Login
          </Link>
        </p>
      </motion.div>
