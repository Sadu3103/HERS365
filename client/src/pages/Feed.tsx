...
export const Feed = () => {
  ...
  const [posts, setPosts] = useState<PostData[]>([
    ...
    },
    {
      ...
      time: '8 hours ago',
      content: "Just got my rankings update - TOP 5% nationally! 🔥 All those early mornings are paying off. Thank you to my coaches and family for believing in me.",
    ...
    {
      id: 4,
      user: { name: 'Coach Rivera', avatar: null },
      time: '12 hours ago',
      content: "Next regional combine is NEXT WEEK. All 2026 & 2027 prospects: register now. Limited spots available. Link in bio. 💪",
      likes: '890',
      comments: '45',
      highlights: false,
      isLiked: false
    ...
    {
      id: 5,
      user: { name: 'Emma O\'Connor', avatar: null },
      time: '1 day ago',
      content: "GPA check: 3.95 ✓ 40yd: 4.88s ✓ Film session coming next week. Ready to show what I can do. 📊",
      likes: '1.8K',
      comments: '203',
      highlights: true,
      isLiked: false
    ...
    {
      id: 6,
      user: { name: 'Scout Davis', avatar: null },
      time: '1 day ago',
      content: "Watched the highlights from the showcase yesterday. There's some serious talent in this 2026 class. This year is going to be special.",
      likes: '567',
      comments: '34',
      highlights: false,
      isLiked: false
