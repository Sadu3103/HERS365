        ...
        <div className="lp-hero-grid" style={{ ...wrap, position: 'relative' }}>
          ...
          >
            ...
            <div style={{
              ...
              boxShadow: '0 8px 22px rgba(139, 59, 255,.45)', lineHeight: 1.2,
            }}>Top 5%</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 10, marginBottom: 18 }}>
              {heroStats.map(s => (
                <div
                  ...
                  onMouseEnter={e => {
                    (e.currentTarget as HTMLDivElement).style.borderColor = 'rgba(139, 59, 255,.28)';
                    (e.currentTarget as HTMLDivElement).style.background = 'rgba(139, 59, 255,.04)';
                  }}
                  onMouseLeave={e => {
