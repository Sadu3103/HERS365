...
const CONFETTI_COLORS = ['#8B3BFF', '#FF2E93', '#ffffff', '#ffd700', '#ff3399', '#4ade80'];
  ...
  return (
    <div>
      ...
      <input
        ...
        onFocus={e => { setFocused(true); e.target.style.borderColor = 'rgba(139, 59, 255,0.55)'; e.target.style.boxShadow = '0 0 0 3px rgba(139, 59, 255,0.09)'; }}
        onBlur={e => { setFocused(false); e.target.style.borderColor = LINE; e.target.style.boxShadow = 'none'; }}
        style={{ ...inputCls, borderColor: focused ? 'rgba(139, 59, 255,0.55)' : LINE }}
      />
    </div>
  );
}
