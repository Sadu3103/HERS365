...
const ATHLETES = [
  ...
  { name: 'Kayla Robinson',  email: 'kayla.robinson@hers365.app',  position: 'WR',         age: 17, state: 'CA', city: 'San Diego',    school: 'Lincoln HS',            gradYear: 2026, g5Rating: 5, gpa: '3.8', tier: 'pro',   archetype: 'Possession',     achievements: '1,100 receiving yds · All-City 1st Team' },
  { name: 'Mia Hernandez',   email: 'mia.hernandez@hers365.app',   position: 'QB',         age: 16, state: 'CA', city: 'Fresno',       school: 'Buchanan HS',           gradYear: 2027, g5Rating: 4, gpa: '3.9', tier: 'free',  archetype: 'Pocket Passer',  achievements: '24 TDs, 3 INTs · academic All-State' },
  { name: 'Trinity Jackson', email: 'trinity.jackson@hers365.app', position: 'Safety',     age: 17, state: 'CA', city: 'Oakland',      school: 'Bishop O\'Dowd',         gradYear: 2026, g5Rating: 4, gpa: '3.4', tier: 'free',  archetype: 'Center Field',   achievements: '7 INTs · 60 flag pulls' },
  { name: 'Gabriela Flores', email: 'gabriela.flores@hers365.app', position: 'RB',         age: 16, state: 'CA', city: 'Bakersfield',  school: 'Garces Memorial',       gradYear: 2027, g5Rating: 4, gpa: '3.7', tier: 'pro',   archetype: 'All-Purpose',    achievements: '1,050 scrimmage yds · 16 TDs' },
  { name: 'Naomi Park',      email: 'naomi.park@hers365.app',      position: 'Cornerback', age: 15, state: 'CA', city: 'Irvine',       school: 'Northwood HS',          gradYear: 2028, g5Rating: 3, gpa: '4.0', tier: 'free',  archetype: 'Press Man',      achievements: 'Sophomore All-League · 4.0 GPA' },
  { name: 'Jada Coleman',    email: 'jada.coleman@hers365.app',    position: 'WR',         age: 17, state: 'CA', city: 'Sacramento',   school: 'Grant Union HS',        gradYear: 2026, g5Rating: 5, gpa: '3.6', tier: 'elite', archetype: 'YAC Threat',     achievements: '19 receiving TDs · regional player of the year' },
  { name: 'Valentina Cruz',  email: 'valentina.cruz@hers365.app',  position: 'Rusher',     age: 16, state: 'CA', city: 'Riverside',    school: 'King HS',               gradYear: 2027, g5Rating: 4, gpa: '3.5', tier: 'free',  archetype: 'Edge Pressure',  achievements: '26 flag pulls behind the line' },
  { name: 'Brooke Sullivan', email: 'brooke.sullivan@hers365.app', position: 'QB',         age: 15, state: 'CA', city: 'Pasadena',     school: 'La Salle HS',           gradYear: 2028, g5Rating: 3, gpa: '3.8', tier: 'free',  archetype: 'Game Manager',   achievements: 'JV MVP · varsity callup' },
  { name: 'Aria Nguyen',     email: 'aria.nguyen@hers365.app',     position: 'Safety',     age: 17, state: 'CA', city: 'San Jose',     school: 'Archbishop Mitty',      gradYear: 2026, g5Rating: 4, gpa: '3.9', tier: 'pro',   archetype: 'Ball Hawk',      achievements: '8 INTs · CCS all-section' },
  { name: 'Simone Carter',   email: 'simone.carter@hers365.app',   position: 'WR',         age: 16, state: 'CA', city: 'Stockton',     school: 'St. Mary\'s HS',         gradYear: 2027, g5Rating: 4, gpa: '3.3', tier: 'free',  archetype: 'Deep Threat',    achievements: '4.6 speed · 900 receiving yds' },
  { name: 'Leah Bennett',    email: 'leah.bennett@hers365.app',    position: 'Center',     age: 16, state: 'CA', city: 'Modesto',      school: 'Central Catholic',      gradYear: 2027, g5Rating: 3, gpa: '3.7', tier: 'free',  archetype: 'Anchor',         achievements: 'Captain · perfect snap rate' },
  { name: 'Camila Torres',   email: 'camila.torres@hers365.app',   position: 'RB',         age: 17, state: 'CA', city: 'Anaheim',      school: 'Esperanza HS',          gradYear: 2026, g5Rating: 5, gpa: '3.6', tier: 'pro',   archetype: 'Burner',         achievements: '4.68 shuttle · 18 rushing TDs · All-County' },
  { name: 'Harper Mitchell', email: 'harper.mitchell@hers365.app', position: 'Cornerback', age: 16, state: 'CA', city: 'Roseville',    school: 'Oakmont HS',            gradYear: 2027, g5Rating: 4, gpa: '3.8', tier: 'free',  archetype: 'Lockdown',       achievements: 'Held opponents to 18% completion on her side' },
];
